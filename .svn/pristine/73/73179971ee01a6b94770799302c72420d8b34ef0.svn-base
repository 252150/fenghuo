...
public class JPushService {
	 ...
	 * @param alertContent          通知内容标题
	 * @param extras            扩展字段
	 */
	public void sendToAliasList(List<String> alias, String notificationTitle, String alertContent,
			Map<String,String> extras) {
		PushPayload pushPayload = buildPushObject_all_aliasList_alertWithTitle(alias, notificationTitle,
				alertContent, extras);
	...
	private PushPayload buildPushObject_all_aliasList_alertWithTitle(List<String> aliasList, String notificationTitle,
			 String alertContent, Map<String,String> extras) {
		...
		return PushPayload.newBuilder()
				...
				.setNotification(Notification.newBuilder()
						...
						.addPlatformNotification(
								AndroidNotification.newBuilder().setAlert(alertContent).setTitle(notificationTitle)
										// 此字段为透传字段，不会显示在通知栏。用户可以通过此字段来做一些定制需求，如特定的key传要指定跳转的页面（value）
	 ...
	 * @return
	 */
	private PushPayload buildPushObject_all_registrationIdsList_alertWithTitle(List<String> tagsList, String notificationTitle,
			String msgTitle, String msgContent, String extras) {
		// 创建一个IosAlert对象，可指定APNs的alert、title等字段
		// IosAlert iosAlert = IosAlert.newBuilder().setTitleAndBody("title",
		// "alert body").build();
	 ...
	 * @param msgContent
	 */
    public void sendToRIdsListdefault(List<String> rIdsList,String notificationTitle,String msgTitle,String msgContent ) {
       // List<String> aliasList = Arrays.asList("170976fa 8acf4909843","100d855909006086b67","18071adc03474ca0fc1");
