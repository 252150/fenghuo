...
public class DateUtils {
    ...
    public static String  currentHHTime() {
    	String ymd="1970-01-01";
    	Calendar now = Calendar.getInstance();
    int year=	now.get(Calendar.HOUR_OF_DAY);
	 int minute=	 now.get(Calendar.MINUTE);
	int day=	 now.get(Calendar.SECOND);
    	 String datetime=ymd+" "+year+":"+minute+":"+day;
